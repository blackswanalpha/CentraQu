    ...
    <div className="card animate-fade-in">
        ...
        <div className="flex justify-center gap-3">
          {code.map((digit, index) => (
            <input
              ...
              className="h-14 w-14 rounded-lg border-2 border-stroke text-center text-xl font-bold text-dark transition-colors focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:bg-neutral-light disabled:opacity-50"
            />
          ))}
        </div>
      ...
      <div className="mt-8 space-y-3 border-t border-stroke pt-6">
        <button
          ...
          className="w-full text-center text-sm text-primary hover:text-primary-hover disabled:opacity-50 font-medium"
        >
        ...
        <div className="flex gap-2 text-center text-sm">
          <button
            type="button"
            disabled={isSubmitting}
            className="flex-1 text-primary hover:text-primary-hover disabled:opacity-50 font-medium"
          >
            Use Backup Code
          </button>
