...
export default function MyTasksPage() {
  // Placeholder for all task data (same as AllTasksPage for consistency)
  const allTasks = [
    {
      id: '1',
  ...
  // Simulate current user and filter tasks
  const currentUser = 'Anya Sharma'; // Example current user
